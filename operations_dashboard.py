...
def load_data():
    try:
        ...
        possible_paths = [
            "spacez_reviews_dataset.xlsx",
            "attachments/spacez_reviews_dataset.xlsx",
            "/mount/src/spacez-operations-dashboard/spacez_reviews_dataset.xlsx"
        ]
...
def categorize_issue(text):
    ...
    if any(word in text_lower for word in ['pool', 'swimming', 'murky', 'dirty pool', 'cleaned']):
...
with tab3:
    ...
    st.info("**Key Insight:** Lokesh Gowda manages multiple properties (Misty Estate & Coorg Canopy). Check-in delays follow him across properties.")

st.caption("Spacez AI Product Associate Prototype • Ratings normalized • Built for Operations stakeholder")
